...
const schema = Joi.object({
  ...
  AI_PROVIDER: Joi.string().valid('mock', 'ollama', 'groq', 'openai').default('mock'),
  AI_FALLBACK_PROVIDER: Joi.string().valid('mock', 'ollama', 'groq', 'openai', '').allow('', null).default('ollama'),
