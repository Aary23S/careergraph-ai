...
const schema = Joi.object({
  ...
  ACCESS_TOKEN_TTL_MINUTES: Joi.number().integer().min(1).default(43200),
  REFRESH_TOKEN_TTL_DAYS: Joi.number().integer().min(1).default(365),
  ...
  APIFY_ENABLED: Joi.boolean().default(false),
  APIFY_API_TOKEN: Joi.string().allow('', null).default(''),
  ...
  AI_PROVIDER: Joi.string().valid('mock', 'ollama', 'groq', 'openai', 'gemini').default('mock'),
  AI_FALLBACK_PROVIDER: Joi.string().valid('mock', 'ollama', 'groq', 'openai', 'gemini', '').allow('', null).default('ollama'),
...
export const env = {
  ...
  apifyEnabled: value.APIFY_ENABLED,
  ...
  geminiEnabled: value.GEMINI_ENABLED,
  ...
  aiFallbackProvider: value.AI_FALLBACK_PROVIDER,
