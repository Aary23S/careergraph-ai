...
def _log_training_run(*, mode, status, dataset_metadata, model_version, hyperparameters, metrics_by_split,
    ...
    params = {
        ...
        "featureSet": dataset_metadata.get("featureSet"),
        "featureSchemaChecksum": dataset_metadata.get("featureSchemaChecksum"),
...
def run_training(
    ...
    model_metadata = {
        ...
        "featureSet": dataset["metadata"].get("featureSet", "opportunity-ranking"),
        "featureSchemaChecksum": dataset["metadata"].get("featureSchemaChecksum"),
        "checksum": checksum,
        "gitCommit": get_git_commit(),
        "pythonVersion": sys.version.split()[0],
    ...
    if register_candidate:
        registry_result = registry_bridge.register_candidate_model(
            ...
            metadata={
                ...
                "featureSet": model_metadata["featureSet"],
                "featureSchemaChecksum": model_metadata["featureSchemaChecksum"],
                "checksum": checksum,
